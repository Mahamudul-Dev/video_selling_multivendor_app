...
class FavouriteModel {
    ...
    factory FavouriteModel.fromJson(Map<String, dynamic> json) => FavouriteModel(
        favouriteItems: json["favouriteItems"] == null ? [] : List<FavouriteItem>.from(json["favouriteItems"]!.map((x) => FavouriteItem.fromJson(x))),
        favouriteId: json["favouriteId"],
    );

    Map<String, dynamic> toJson() => {
        "favouriteItems": favouriteItems == null ? [] : List<dynamic>.from(favouriteItems!.map((x) => x.toJson())),
